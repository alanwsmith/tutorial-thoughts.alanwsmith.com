...
`}</span>
      ...
      <div className="token-line code_line line_added">
        <span className="code_line_number">20</span>
        <span className="code_line_content added_top">{`      <input `}</span>
      </div>
      <div className="token-line code_line line_added">
...
`}</span>
      ...
      <div className="token-line code_line line_added">
        ...
        <span className="code_line_content added_bottom">{`      />`}</span>
      </div>
      <div className="token-line code_line">
      ...
      <div className="token-line code_line">
        <span className="code_line_number code_line_number_last">38</span>
        <span className="code_line_content">{`      <Outlet />`}</span>
      </div>
      <div className="token-line code_line">
      ...
      <div className="token-line code_line">
        <span className="code_line_number code_line_number_last">41</span>
        <span className="code_line_content">{`}`}</span>
      </div>
    </pre>
  )
