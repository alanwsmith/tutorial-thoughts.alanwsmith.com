...
`}</span>
      ...
      <div className="token-line code_line line_added">
        ...
        <span className="code_line_content added_top added_bottom">{`            let name = invoice.name.toLowerCase();`}</span>
      </div>
      <div className="token-line code_line">
      ...
      <div className="token-line code_line">
        <span className="code_line_number code_line_number_last">54</span>
        <span className="code_line_content">{`}`}</span>
      </div>
    </pre>
  )
